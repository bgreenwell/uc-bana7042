...
**Question 6.** For ease of notation, let $\eta = \boldsymbol{x}^\top\boldsymbol{\beta} = \beta_0 + \beta_1 x_1 + \beta_2 x_1 + \cdots + \beta_p x_p$ be the linear predictor. For the LR model 
$$
