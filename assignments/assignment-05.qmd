...
Please review Chapter 7 of "Extending the Linear Model with R: Generalized Linear, Mixed Effects and Nonparametric Regression Models" (second edition) by Julian J. Faraway. The chapter covers multinomial and ordinal regression models, which are used for modeling categorical response variables with more than two categories. You can find a PDF copy of the book in `resources/elmr2.pdf`.
